...
import { Eye, EyeOff, Mail, Lock, Loader2, GraduationCap, BookOpen } from "lucide-react"
      ...
      <Card className="w-full max-w-md shadow-lg border-border/50">
        <CardHeader className="space-y-2 text-center pb-4">
          ...
          <p className="text-sm text-muted-foreground">
            Join us to access thousands of books and learning resources
          </p>
        </CardHeader>
        <CardContent className="space-y-5">
          <div className="space-y-3">
            <Button
              type="button"
              variant="outline"
              className="w-full h-11 text-sm font-medium hover:bg-accent transition-colors"
